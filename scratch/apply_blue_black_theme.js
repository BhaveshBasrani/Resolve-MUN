...
// 1. UPDATE GLOBALS.CSS TO TYPEFORM BLUE & BLACK
const globalsCss = `/* ==========================================================================
   RESOLVE MUN 2.0 — TYPEFORM AESTHETIC (ELECTRIC BLUE & OBSIDIAN BLACK)
   Clean, interactive, elegant, minimal, and highly polished SaaS design.
   Colors: Obsidian Black (#08090d), Slate (#0e1118), Electric Blue (#2563eb / #3b82f6)
...
:root {
  ...
  /* Typeform / Modern Electric Blue Accent */
  --blue: #2563eb;
  --blue-bright: #3b82f6;
  --blue-light: #60a5fa;
  --blue-hover: #1d4ed8;
  ...
  /* Radii (Typeform smooth rounded feel) */
  --radius-xs: 6px;
  --radius-sm: 10px;
  --radius-md: 14px;
  --radius-lg: 20px;
...
/* --------------------------------------------------------------------------
   BUTTONS & ACTIONS (TYPEFORM PILL & SOFT RADIUS)
   -------------------------------------------------------------------------- */
.btn-primary,
button.btn-primary,
a.btn-primary {
...
/* --------------------------------------------------------------------------
   ARCHITECTURE MATRIX & WHY MATTERS CARD
   -------------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------------
   MODALS (CONVERSATIONAL TYPEFORM STYLE)
   -------------------------------------------------------------------------- */
.modal-overlay {
  position: fixed;
  inset: 0;
...
/* Form Styles (Conversational Inputs) */
.form-step {
  display: none;
}
...
console.log('Successfully updated app/globals.css with Blue & Black Typeform aesthetic!');
